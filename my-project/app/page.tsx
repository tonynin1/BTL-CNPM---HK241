...
export default function Home() {
  return (
    <>
      <div className="screen flex h-fit max-w-full justify-center pt-5">
        <div className="container w-[600px] border-2 p-3">
          <div className="relative flex">
            ...
            <div className="ml-3">
              <div className="mt-2 flex justify-between">
                <div>
                  <a href="#" className="bold font-bold">
                    harleylarouxwriter
                  </a>
                  <span className="ml-2 text-xs text-zinc-500">20h</span>
                </div>
                <div className="mr-2">
                  <svg
                    className="h-6 w-6"
              ...
              <div className="content my-2 leading-7">
                Seeing those screenshots of an author getting excessively angry
                about a reader misspelling their character's name is honestly
                cracking me up 😂 It's quite literally a daily occurrence for
                folks to call Manson "Mason." Hell, I misspell MY OWN
                CHARACTER'S NAMES, that's part of why I need an editor, lol.
                This is going to sound rich coming from me, a diagnosed stress
                case, but - some of y'all gotta chill.
              </div>
              ...
              <div className="flex gap-5">
                <div className="flex justify-end">
                  ...
                  <span className="text-sm text-zinc-600">162</span>
                </div>
